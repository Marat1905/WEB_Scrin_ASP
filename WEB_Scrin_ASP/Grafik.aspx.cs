...
{
    public partial class Grafik : BasePage   // изменено с System.Web.UI.Page на BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (DateTime.Now.Year < 2050)
            {
                ...
                try
                {
                    switch (month)
                    {
                        case 1: Label_Grafik.Text = "График работы персонала на январь месяц."; break;
                        case 2: Label_Grafik.Text = "График работы персонала на февраль месяц."; break;
                        case 3: Label_Grafik.Text = "График работы персонала на март месяц."; break;
                        case 4: Label_Grafik.Text = "График работы персонала на апрель месяц."; break;
                        case 5: Label_Grafik.Text = "График работы персонала на май месяц."; break;
                        case 6: Label_Grafik.Text = "График работы персонала на июнь месяц."; break;
                        case 7: Label_Grafik.Text = "График работы персонала на июль месяц."; break;
                        case 8: Label_Grafik.Text = "График работы персонала на август месяц."; break;
                        case 9: Label_Grafik.Text = "График работы персонала на сентябрь месяц."; break;
                        case 10: Label_Grafik.Text = "График работы персонала на октябрь месяц."; break;
                        case 11: Label_Grafik.Text = "График работы персонала на ноябрь месяц."; break;
                        case 12: Label_Grafik.Text = "График работы персонала на декабрь месяц."; break;
                    }
                }
                ...
                // Читаем данные для каждой должности
                for (int i = 1; i < 10; i++)
                {
                    try
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(connectionString))
                        {
                            ...
                            switch (i)
                            {
                                case 1: GridView1.DataSource = dataTable; GridView1.DataBind(); break;
                                case 2: GridView2.DataSource = dataTable; GridView2.DataBind(); break;
                                case 3: GridView3.DataSource = dataTable; GridView3.DataBind(); break;
                                case 4: GridView4.DataSource = dataTable; GridView4.DataBind(); break;
                                case 5: GridView5.DataSource = dataTable; GridView5.DataBind(); break;
                                case 6: GridView6.DataSource = dataTable; GridView6.DataBind(); break;
                                case 7: GridView7.DataSource = dataTable; GridView7.DataBind(); break;
                                case 8: GridView8.DataSource = dataTable; GridView8.DataBind(); break;
                                case 9: GridView9.DataSource = dataTable; GridView9.DataBind(); break;
                            }
                        }
                    }
                    catch { /* игнорируем ошибки отдельных запросов */ }
                }
            }
        }
