<%@ Page Title="" Language="C#" MasterPageFile="~/Screen.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="WEB_Scrin_ASP._default" Async="true" %>
        ...
        <div class="columns">
            ...
            <div class="layer1">
                <div class="row_Ri">
                    ...
                    <div class="col-1-3L"><asp:TextBox ID="textbox1" Class="textbox_lbl_Ri" Text="м/мин." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3L"><asp:TextBox ID="textbox4" Class="textbox_lbl_Ri" Text="м/мин." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3L"><asp:TextBox ID="textbox6" Class="textbox_lbl_Ri" Text="г/м2." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3L"><asp:TextBox ID="textbox12" Class="textbox_lbl_Ri" Text="г/м2." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3L"><asp:TextBox ID="textbox8" Class="textbox_lbl_Ri" Text="шт." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3L"><asp:TextBox ID="textbox10" Class="textbox_lbl_Ri" Text="шт." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3L"><asp:TextBox ID="textbox26" Class="textbox_lbl_Ri" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3L"><asp:TextBox ID="textbox28" Class="textbox_lbl_Ri" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3La"><asp:TextBox ID="textbox2" Class="textbox_lbl_Ri" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3La"><asp:TextBox ID="textbox20" Class="textbox_lbl_Li" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
            </div>
            ...
            <div class="layer2">
                <div class="row_Ri">
                    ...
                    <div class="col-1-3Li"><asp:TextBox ID="textbox47" Class="textbox_lbl_Li" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3Li"><asp:TextBox ID="textbox14" Class="textbox_lbl_Li" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3Li"><asp:TextBox ID="textbox22" Class="textbox_lbl_Li" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3Li"><asp:TextBox ID="textbox24" Class="textbox_lbl_Li" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
                <div class="row_Ri">
                    ...
                    <div class="col-1-3Li"><asp:TextBox ID="textbox18" Class="textbox_lbl_Li" Text="кг." runat="server" ReadOnly="True" /></div>
                </div>
